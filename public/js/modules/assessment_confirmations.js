...
if (typeof AssessmentConfirmations === 'undefined') {
    class AssessmentConfirmations {
        ...
        init() {
            ...
            document.addEventListener('click', (e) => {
                const btn = e.target.closest('.delete-assessment-question');
                if (btn) {
                    e.preventDefault();
                    e.stopPropagation(); // Prevent global handler from firing
                    this.handleQuestionDelete(btn);
                }
            });
        }
        ...
        handleQuestionDelete(button) {
            ...
            console.log('Assessment Delete Clicked:', data); // Debug log
            if (!data.id) {
        ...
        extractQuestionData(button) {
            return {
                ...
                action: `/unlockyourskills/vlr/questions/${button.dataset.id}/delete`
            };
        }
        ...
        static deleteQuestion(id, title) {
            const url = `/unlockyourskills/vlr/questions/${id}/delete`;
