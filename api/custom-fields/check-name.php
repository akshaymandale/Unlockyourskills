<?php
/**
 * API endpoint to check if custom field name already exists
 */
...
try {
    ...
    $exists = $customFieldModel->checkFieldNameExists($fieldName, $clientId, $excludeId);

    echo json_encode(['exists' => $exists]);

} catch (Exception $e) {
    error_log("API check-name error: " . $e->getMessage());
