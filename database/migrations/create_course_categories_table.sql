...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Course categories table';
...
INSERT INTO `course_categories` (`id`, `client_id`, `name`, `description`, `sort_order`, `is_active`, `created_by`) VALUES
(1, 1, 'Programming & Development', 'Software development, coding, and programming languages', 1, 1, 44),
(2, 1, 'Business & Management', 'Business administration, management, and leadership', 2, 1, 44),
(3, 1, 'Design & Creative', 'Graphic design, UI/UX, and creative arts', 3, 1, 44),
(4, 1, 'Marketing & Sales', 'Digital marketing, sales techniques, and advertising', 4, 1, 44),
(5, 1, 'Technology & IT', 'Information technology, systems, and infrastructure', 5, 1, 44),
(6, 1, 'Healthcare & Medical', 'Medical training, healthcare administration', 6, 1, 44),
(7, 1, 'Education & Training', 'Teaching methodologies and educational content', 7, 1, 44),
(8, 1, 'Finance & Accounting', 'Financial management, accounting, and investment', 8, 1, 44);
