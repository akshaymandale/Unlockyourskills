-- Progress Tracking System - Step by Step Migration
-- This migration creates a comprehensive progress tracking system that works with course_applicability
-- Date: 2025-01-30

-- =====================================================
-- STEP 1: CREATE NEW PROGRESS TABLES
-- =====================================================

-- User Course Progress Table (replaces course_enrollments dependency)
...
-- =====================================================
-- STEP 2: CREATE CONTENT-SPECIFIC PROGRESS TABLES
-- =====================================================
...
-- =====================================================
-- STEP 3: CREATE PROGRESS CALCULATION VIEW
-- =====================================================

-- Course Progress Summary View (simplified for now)
...
SELECT 
    ...
    0 as completed_content_items,
    ucp.completion_percentage as calculated_progress
...
-- 1. Creates new progress tracking tables for all content types
-- 2. Works with course_applicability instead of course_enrollments
-- 3. Provides content-specific progress tracking for all VLR types
-- 4. Enables resume functionality for interrupted sessions
-- 5. Calculates progress based on content type and completion criteria
-- 6. Maintains backward compatibility with existing progress tables
-- 7. Works seamlessly with course_applicability system

-- Note: The existing module_progress and content_progress tables are left unchanged
-- to maintain backward compatibility. New progress tracking will use the new tables.
