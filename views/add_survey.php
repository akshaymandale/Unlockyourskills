    ...
    <div class="container-fluid mb-3">
      <div class="row justify-content-between align-items-center g-3">
        ...
        <div class="col-md-auto">
          <select class="form-select form-select-sm" multiple name="surveyFiltersSelect" id="surveyFiltersSelect"
        ...
        <div class="col-md-auto">
          <div class="input-group input-group-sm">
            <input type="text" id="searchSurveyQuestionInput" name="searchSurveyQuestionInput" class="form-control"
          ...
          <div class="col-md-auto">
            ...
            <div class="modal fade" id="addSurveyQuestionModal" tabindex="-1"
              ...
              -->
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" id="addOptionBtn">Add
                          Option</button>
                      </div>
      ...
      <?php if ($totalPages > 1): ?>
        <nav>
          <ul class="pagination justify-content-center">
            <?php if ($page > 1): ?>
              <li class="page-item">
                <a class="page-link" href="index.php?controller=SurveyQuestionController&page=<?= $page - 1; ?>">«
            ...
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
              <li class="page-item <?= ($i == $page) ? 'active' : ''; ?>">
                <a class="page-link" href="index.php?controller=SurveyQuestionController&page=<?= $i; ?>"><?= $i; ?></a>
              </li>
            <?php endfor; ?>
